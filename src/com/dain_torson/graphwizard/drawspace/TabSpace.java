...
public class TabSpace extends TabPane{
    ...
    public TabSpace(Stage stage) {
        ...
        drawTab.setOnSelectionChanged(new TabSelectionChangedHandler());
    ...
    public void addNewTab(){
        ...
        tempTab.setOnSelectionChanged(new TabSelectionChangedHandler());
    ...
    private class TabSelectionChangedHandler implements EventHandler<Event> {
        ...
        public void handle(Event event) {
            DrawTab targetTab = tabList.get(0);
            for(DrawTab drawTab : tabList) {
